import { github, instagram, linkedin, userImg2, vectorblue, vectorred, webdev, webdev2 } from '../../Assests';
        ...
        <div className='flex flex-col-reverse lg:!flex-row items-center h-screen max-h-full relative w-full px-5 lg:!px-16'>
            <div className='h-full flex flex-col justify-center items-center lg:!items-start gap-4 md:!gap-8 intro-name pt-8 md:!pt-0 w-full'>
                ...
                <motion.button
                    ...
                    viewport={{ once: true }}
                    transition={transition}
                    className="button bg-gradient-to-r from-yellow-500 to-orange-500 hover:from-white hover:to-white hover:text-yellow-500 border-2 border-yellow-500 text-white px-4 py-2 !flex !items-center !justify-center text-[1rem] sm:!text-[1.1rem] lg:!text-[1.3rem] rounded-full font-mova">Hire me</motion.button>
                <motion.div
                    initial={{ opacity: 0 }}
                    whileInView={{ opacity: 1 }}
                    viewport={{ once: false }}
                    transition={transition}
                    className="flex items-center justify-center gap-8 mt-4 intro-icons">
