...
const FloatingDiv = ({image,texttitle,textsubtitle}:any) =>{
    return(
        <div className="flex justify-around items-center h-[3rem] w-auto !bg-white rounded-md floating-div px-2 py-4 transition hover:scale-110 hover:duration-300 hover:ease-in">
