...
const Card = ({image,title,subtitle}:any) =>{
    return(
        <div className="card flex flex-col items-center justify-center text-center rounded-lg w-full h-[16rem] sm:!h-[17rem] lg:!w-[13-rem] my-4 mx-2 py-6 gap-2 relative">
